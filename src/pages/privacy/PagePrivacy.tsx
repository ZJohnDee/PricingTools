export default () => {
  return (
    <div style={{padding: "20px"}}>
      ...
      Ihren personenbezogenen Daten passiert, wenn Sie diese Website besuchen. Personenbezogene Daten sind alle Daten,
      mit denen Sie pers&ouml;nlich identifiziert werden k&ouml;nnen. Ausf&uuml;hrliche Informationen zum Thema
      ...
      Website?</h4> <p>Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten
      ...
      Nutzerverhaltens verwendet werden.</p> <h4>Welche Rechte haben Sie bez&uuml;glich Ihrer Daten?</h4> <p>Sie haben
      ...
      steht Ihnen ein Beschwerderecht bei der zust&auml;ndigen Aufsichtsbeh&ouml;rde zu.</p> <p>Hierzu sowie zu weiteren
      Fragen zum Thema Datenschutz k&ouml;nnen Sie sich jederzeit an uns wenden.</p>
      ...
      <p>Der Einsatz des Hosters erfolgt zum Zwecke der Vertragserf&uuml;llung gegen&uuml;ber unseren potenziellen und
        ...
        umfasst. Die Einwilligung ist jederzeit widerrufbar.</p> <p>Unser Hoster wird Ihre Daten nur insoweit
      verarbeiten, wie dies zur Erf&uuml;llung seiner Leistungspflichten erforderlich ist und unsere Weisungen in Bezug
      auf diese Daten befolgen.</p> <p>Wir setzen folgenden Hoster ein:</p>
      <p>Netlify, Inc., located at 44 Montgomery Street, Suite 300, San Francisco, California 94104.<br/>
        https://www.netlify.com/privacy</p>
      <h4>Auftragsverarbeitung</h4> <p>Wir haben einen Vertrag &uuml;ber Auftragsverarbeitung (AVV) mit dem oben
      genannten Anbieter geschlossen. Hierbei handelt es sich um einen datenschutzrechtlich vorgeschriebenen Vertrag,
      der gew&auml;hrleistet, dass dieser die personenbezogenen Daten unserer Websitebesucher nur nach unseren Weisungen
      ...
      dieser Website ist:</p> <p>John Dee Zimmermann<br/>
      John Dee Software<br/>
      Steingewann 1B<br/>
      67551 Worms<br/>
      Deutschland</p>

      <p>Telefon: 01729963590<br/>
      ...
      Datenverarbeitung widerrufen, werden Ihre Daten gel&ouml;scht, sofern wir keine anderen rechtlich zul&auml;ssigen
      Gr&uuml;nde f&uuml;r die Speicherung Ihrer personenbezogenen Daten haben (z.&nbsp;B. steuer- oder
      handelsrechtliche Aufbewahrungsfristen); im letztgenannten Fall erfolgt die L&ouml;schung nach Fortfall dieser
      Gr&uuml;nde.</p>
      ...
      lit. a DSGVO bzw. Art. 9 Abs. 2 lit. a DSGVO, sofern besondere Datenkategorien nach Art. 9 Abs. 1 DSGVO
      ...
      via Device-Fingerprinting) eingewilligt haben, erfolgt die Datenverarbeitung zus&auml;tzlich auf Grundlage
      von &sect; 25 Abs. 1 TTDSG. Die Einwilligung ist jederzeit widerrufbar. Sind Ihre Daten zur Vertragserf&uuml;llung
      oder zur Durchf&uuml;hrung vorvertraglicher Ma&szlig;nahmen erforderlich, verarbeiten wir Ihre Daten auf Grundlage
      des Art. 6 Abs. 1 lit. b DSGVO. Des Weiteren verarbeiten wir Ihre Daten, sofern diese zur Erf&uuml;llung einer
      ...
      werden. Wir weisen darauf hin, dass in diesen L&auml;ndern kein mit der EU vergleichbares Datenschutzniveau
      garantiert werden kann. Beispielsweise sind US-Unternehmen dazu verpflichtet, personenbezogene Daten an
      Sicherheitsbeh&ouml;rden herauszugeben, ohne dass Sie als Betroffener hiergegen gerichtlich vorgehen k&ouml;nnten.
      ...
      Verarbeitungst&auml;tigkeiten keinen Einfluss.</p><h3>Widerruf Ihrer Einwilligung zur Datenverarbeitung</h3>
      ...
      JEDERZEIT DAS RECHT, AUS GR&Uuml;NDEN, DIE SICH AUS IHRER BESONDEREN SITUATION ERGEBEN, GEGEN DIE VERARBEITUNG
      IHRER PERSONENBEZOGENEN DATEN WIDERSPRUCH EINZULEGEN; DIES GILT AUCH F&Uuml;R EIN AUF DIESE BESTIMMUNGEN
      ...
      DSGVO).</p> <p>WERDEN IHRE PERSONENBEZOGENEN DATEN VERARBEITET, UM DIREKTWERBUNG ZU BETREIBEN, SO HABEN SIE DAS
      ...
      einem g&auml;ngigen, maschinenlesbaren Format aush&auml;ndigen zu lassen. Sofern Sie die direkte &Uuml;bertragung
      ...
      Seitenbetreiber senden, eine SSL- bzw. TLS-Verschl&uuml;sselung. Eine verschl&uuml;sselte Verbindung erkennen Sie
      daran, dass die Adresszeile des Browsers von &bdquo;http://&ldquo; auf &bdquo;https://&ldquo; wechselt und an dem
      Schloss-Symbol in Ihrer Browserzeile.</p> <p>Wenn die SSL- bzw. TLS-Verschl&uuml;sselung aktiviert ist,
      ...
      L&ouml;schung dieser Daten. Hierzu sowie zu weiteren Fragen zum Thema personenbezogene Daten k&ouml;nnen Sie sich
      ...
      Verarbeitung Ihrer personenbezogenen Daten zu verlangen. Hierzu k&ouml;nnen Sie sich jederzeit an uns wenden. Das
      ...
      <p>Eine Zusammenf&uuml;hrung dieser Daten mit anderen Datenquellen wird nicht vorgenommen.</p> <p>Die Erfassung
      ...
      <h3>Google Web Fonts</h3> <p>Diese Seite nutzt zur einheitlichen Darstellung von Schriftarten so genannte Web
      Fonts, die von Google bereitgestellt werden. Beim Aufruf einer Seite l&auml;dt Ihr Browser die ben&ouml;tigten Web
      ...
      dar&uuml;ber, dass &uuml;ber Ihre IP-Adresse diese Website aufgerufen wurde. Die Nutzung von Google WebFonts
      ...
      jederzeit widerrufbar.</p> <p>Wenn Ihr Browser Web Fonts nicht unterst&uuml;tzt, wird eine Standardschrift von
      Ihrem Computer genutzt.</p> <p>Weitere Informationen zu Google Web Fonts finden Sie unter <a
      ...
      <p>
        ...
        Diese Seite nutzt Google Firebase zur Speicherung nutzererstellter Daten. Firebase ermöglicht es uns, Ihre Daten
        in einer Datenbank zu speichern
        und Nutzerauthentifikation anzubieten. <br/>
        Keine Daten werden ohne Einwilligung des Nutzers gespeichert. Zudem speichern wir selbst keine Daten auf
        Firebase, welche nicht vom Nutzer selbst
        eingegeben wurden, mit Ausnahme der sogenannten UID (User Identifier), mit welcher wir Ihre eingegebenen Daten,
        Ihrem Nutzeraccount zuordnen könnnen. <br/>
        Die Daten liegen verschlüsselt auf dem Server und sind somit theoretisch nicht einsichtbar für dritte. Komplette
        Sicherheit kann jedoch in
        der IT <b>nie</b> garantiert werden. Es ist durchaus möglich, dass Google-Mitarbeiter einen Schlüssel besitzen,
        mit welchem
        sich Ihre Daten entschlüsseln ließen. Zusätzlich ist es uns als Betreiber der Seite auch möglich, Ihre Daten
        einzusehen, zu bearbeiten und zu löschen.
        Wir haben allerdings kein Interesse daran, dies ungefragt zu tun.
        Falls Sie Ihre Daten gelöscht haben wollen, so kontaktieren Sie uns bitte unter
        contact@johndee-software.de. <br/>
        Google erhebt zusätzlich eigene Log-Files. Ihre IP-Addresse ist dem Anbieter sichtbar.

        Google: <a href="https://firebase.google.com/support/privacy" target="_blank"
                   rel="noopener noreferrer">https://firebase.google.com/support/privacy</a>.

      </p>

      <h3>Google Auth durch Firebase</h3>

      <p>
        Diese Seite nutzt Google Auth durch Firebase zur Benutzeraccounterstellung. Sie benötigen dafür einen Account bei Google.
        Die Registrierung bei Google erfolgt nicht ungefragt, ist jedoch erforderlich um erweiterte Funktionen unserer Seite zu nutzen.
        Google erhält somit persönliche Daten über Sie. In welchem Ausmaß, erfahren Sie in der Datenschutzerklärung von Google.
        Durch die Nutzung von Google, erhalten wir demnach auch persönliche Informationen über Sie, wie E-Mail, Name und Profilbild.
        Auf der gesamten Website fragen wir jedoch nur die UID (User Identifier) ab, womit wir Ihre Nutzerdaten Ihrem Nutzeraccount
        zuordnen können. Die Einsicht aller Ihrer Daten ist jedoch theoretisch möglich, jedoch haben wir kein Interesse darin,
        dies ungefragt zu tun. <br/>
        Da es sich bei Google um ein amerikanisches Unternehmen handelt, kann es sein, dass manche Ihrer Daten auf amerikanischen Servern gespeichert werden.
